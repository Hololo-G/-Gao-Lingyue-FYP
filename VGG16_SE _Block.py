...
class EarlyStopping:
    ...
    def save_checkpoint(self, val_loss, model):
        saved_path = 'C:/Users/Easyai/Desktop/gly/code/saved_models/initialization_b20_se.pth'
        checkpoint = {
...
for name, module in model.named_children():
    if name == 'features':
        ...
        for n, m in module.named_children():
            ...
            if isinstance(m, nn.Conv2d) and n == '7':  # 在最后一个卷积层后添加SE Block
                # 获取输入通道数
...
def main():
    ...
    checkpoint = torch.load('C:/Users/Easyai/Desktop/gly/code/saved_models/initialization_b20_se.pth', map_location=device)
